...
<div class="container">
                    ...
                    <div class="container-fluid px-4">
                        <h2 class="mt-4 text-white text-capitalize">{{$door_name}} Door Action Logs</h2>
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    @foreach($door_logs as $door_log)
                                        <tr>
                                            ...
                                            <td>{{$door_log['fname'] .' '. $door_log['lname']}}</td>
                                            <td>{{$door_log['permissioner_fname'] .' '. $door_log['permissioner_lname']}}</td>
                                            <td>{{$door_log['status']}}</td>
