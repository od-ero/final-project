...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="/welcome">Admin Unikey</a>
            <!-- Sidebar Toggle-->
                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseLayouts" aria-expanded="false" aria-controls="collapseLayouts">
                                <div class="sb-nav-link-icon"><i class="fas  fa-house-medical"></i></div>
                                Rooms
 ...
 @if(isset($nav_unit_id))
    <div>
        ...
        <div class="small text-uppercase">Logged in :</div>
          ...
          <div class="text-uppercase">{{$nav_unit['unit_name'] .',  '.  $nav_unit['premises_name']}}</div> 
    </div>
@else
    <div>
