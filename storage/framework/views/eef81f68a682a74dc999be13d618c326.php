...
<body class="bg-darnger text-white p-3 m-0 border-0 bd-example">
      ...
      <a href="#" class="btn btn-info btn-lg">
        ...
        <form class="d-flex" role="search">
          ...
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <?php if(isset($encoded_permission_id)): ?>
            <li class="nav-item">
              <a class="nav-link" href="/add/permissions/<?php echo e($encoded_permission_id); ?>">Give Permission</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="/make/schedule/<?php echo e($encoded_permission_id); ?>">Activate Button Access</a>
            </li>
            <?php endif; ?>
          ...
          <div class="text-end">
          <a href="<?php echo e(route('logout.perform')); ?>" class="btn btn-outline-danger me-2">Logout</a>
        </div>
        <?php endif; ?>
        <?php if(auth()->guard()->guest()): ?>
        <div class="text-end">
    ...
    <!-- End Example Code -->
  </body><?php /**PATH C:\xampp\htdocs\LaravelAPI\resources\views/layouts/partials/navbar.blade.php ENDPATH**/ ?>