...
window.addEventListener('DOMContentLoaded', event => {
    ...
    if (datatablesSimple) {
        ...
        <script src="adminstration::resources/assets/js/demo/chart-area-demo.js"></script>
        <script src="adminstration::resources/assets/js/demo/chart-bar-demo.js"></script>
        <script src="https://cdn.jsdelivr.net/npm/simple-datatables@7.1.2/dist/umd/simple-datatables.min.js" crossorigin="anonymous"></script>
        <script src="js/datatables-simple-demo.js"></script>
    </body>
</html>
<?php /**PATH C:\xampp\htdocs\LaravelAPI\Modules/Adminstration\resources/views/home/test.blade.php ENDPATH**/ ?>