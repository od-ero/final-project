...
<div class="d-flex justify-content-between align-items-center">
    <p>Welcome to <b class="text-uppercase"><?php echo e($unit['premises_name'] . ', ' . $unit['unit_name']); ?></b> Ip addresses </p>
...
$(function () {
    ...
    render: function(data, type, row, meta) {
        ...
        return `
            <div class='btn-group'>
              <a href="<?php echo e(url('units/doors/ip/show/')); ?>/${data}/${encoded_permission_id}" class='btn btn-success'>
                    <span>edit</span>
                </a>
            </div>
        `;
