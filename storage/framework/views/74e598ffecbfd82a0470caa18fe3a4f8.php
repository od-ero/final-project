        ...
        <div class="row">
            <div class="col">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <a href="/add/group/schedule/user/<?php echo e($encoded_permission_id); ?>" class="btn btn-outline-success block mx-3">Add Schedule Group</a>
...
<?php echo $__env->make('layouts.app-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\LaravelAPI\resources\views/schedule/scheduleGroups.blade.php ENDPATH**/ ?>